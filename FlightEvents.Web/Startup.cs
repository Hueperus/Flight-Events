        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                .AddOpenIdConnect("Microsoft", o =>
                {
                    ...
                    o.Authority = $"https://login.microsoftonline.com/{Configuration["Authentication:Microsoft:TenantId"]}/v2.0";
                    o.CallbackPath = "/signin-microsoft";
                    o.Scope.Add("openid");
                    o.SignInScheme = CookieAuthenticationDefaults.AuthenticationScheme;
                    o.RemoteSignOutPath = "/signout-microsoft";
                    ...
                    o.TokenValidationParameters.IssuerValidator = new IssuerValidator((issuer, token, parameters) =>
                    {
